...
class FixNullUniqueIndexesForRemoteTargets < ActiveRecord::Migration[7.2]
  def up
    ...
    # Local grantee
    unless index_name_exists?(:better_together_person_access_grants,
    ...
    # Remote grantee
    return if index_name_exists?(:better_together_person_access_grants,
  ...
  def down
    ...
    return if index_name_exists?(:better_together_person_access_grants,
                                 'index_bt_person_access_grants_on_link_and_people')
