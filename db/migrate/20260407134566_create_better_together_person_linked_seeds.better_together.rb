...
class CreateBetterTogetherPersonLinkedSeeds < ActiveRecord::Migration[7.2]
  def change
    ...
    unless index_name_exists?(:better_together_person_linked_seeds,
                              'index_bt_person_linked_seeds_on_grant_and_identifier')
    ...
    unless index_name_exists?(:better_together_person_linked_seeds,
                              'index_bt_person_linked_seeds_on_recipient_person_id')
    ...
    return if index_name_exists?(:better_together_person_linked_seeds,
                                 'index_bt_person_linked_seeds_on_source_platform_id')
